...
<html>
	...
	<script type="text/javascript">
		...
		function boardCheck() {
			if (document.articleForm.q_id.value.length == 0) {
				alert("작성자를 입력하세요.");
				return false;
			}
			if (document.articleForm.q_title.value.length == 0) {
				alert("제목을 입력하세요.");
				return false;
			}
			if (document.articleForm.q_content.value.length == 0) {
				alert("내용을 입력하세요.");
				return false;
			}
			return true;
...
<body>
	<div class="container">
		<section class="notice">
			...
			<form action="${contextPath}/Qboard/QaddArticle.do" name="articleForm" method="post" enctype="multipart/form-data">
				<table class="table table-hover">
					<tbody>
						<tr> 
							<td style="font-family:돋음; font-size:12" height="16" >
								<div align="left" >
									<input name="q_id" type="text" class="form-control" maxlength="20"  placeholder="작성자" />   
								</div> 
							</td> 
						</tr> 
						<tr>
