                            ...
                            <div class="container">
                                <div class="search-window">
                                    <div
                                        class="search-wrap">
                                        <!-- 검색 -->
                                        <form action="${pageContext.request.contextPath}/Qboard/QlistArticles.do">
                                            <select name="action" class="select">
                                                <option value="listMembers">전체</option>
                                                <option value="selectMemberById">작성자</option>
                                                <option value="selectMemberByTitle">제목</option>
                                            </select>
                                            <input type="text" name="" placeholder="검색어를 입력해주세요." />
                                            <input id="search" type="submit" class="btn btn-dark"  value="검색"></form>
                                        </div>
                                    </div>
                                </div>
                            </div>
